...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                // DB has been seeded | A DB foi populado
                return;
            }
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@company.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@company.com", new DateTime(1971, 2, 12), 2300.0, d2);
            Seller s3 = new Seller(3, "Sergei Zaikin", "sergei@company.com", new DateTime(1988, 4, 14), 1400.0, d1);
            Seller s4 = new Seller(4, "Andrey Gusev", "andrey@company.com", new DateTime(1991, 6, 8), 3100.0, d4);
            Seller s5 = new Seller(5, "Alexey Emelianov", "alexey@company.com", new DateTime(1993, 1, 3), 4200.0, d3);
            Seller s6 = new Seller(6, "Vitaliy Zolin", "vitaliy@company.com", new DateTime(1967, 12, 22), 4400.0, d2);
            Seller s7 = new Seller(7, "Lorenna Petri", "lorenna@company.com", new DateTime(1990, 9, 18), 5200.0, d4);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s7);
            ...
            SalesRecord r6 = new SalesRecord(6, new DateTime(2018, 09, 15), 2000.0, SaleStatus.Billed, s7);
            ...
            SalesRecord r20 = new SalesRecord(20, new DateTime(2018, 10, 15), 8000.0, SaleStatus.Billed, s7);
